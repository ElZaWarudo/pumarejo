...
auth_file="/tmp/tauri-agent-u9-xvfb.auth"
cookie_file="/tmp/tauri-agent-u9-xvfb.cookie"
...
XAUTHORITY="$auth_file" Xvfb :98 -screen 0 1280x800x24 \
  ...
  >/tmp/tauri-agent-u9-xvfb.log 2>&1 &
xvfb_pid=$!
...
export TAURI_AGENT_BACKGROUND_DISPLAY=127.0.0.1:98
export TAURI_AGENT_RUN_RUNTIME_MODES=1
export TAURI_AGENT_PROVIDER_READY_TIMEOUT_MS=600000
export TAURI_AGENT_LIVE_TARGET_DIR="$HOME/.cache/tauri-agent-runtime-modes-target"
